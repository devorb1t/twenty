...
| **View** | Pre-configured record list views | [Skills & Agents](/developers/extend/apps/skills-and-agents) |
| **Navigation Menu Item** | Custom sidebar entries | [Skills & Agents](/developers/extend/apps/skills-and-agents) |
| **Page Layout** | Custom record page tabs and widgets | [Skills & Agents](/developers/extend/apps/skills-and-agents) |
...
<CardGroup cols={2}>
  ...
  <Card title="Skills & Agents" icon="robot" href="/developers/extend/apps/skills-and-agents">
    AI capabilities, views, navigation, and page layouts.
  </Card>
