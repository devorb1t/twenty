...
import { SidePanelFieldWidgetTableFieldsSubPage } from '@/side-panel/pages/page-layout/components/SidePanelFieldWidgetTableFieldsSubPage';
...
>([
  ...
  [
    ...
    <SidePanelFieldWidgetTableFieldsSubPage />,
  ],
